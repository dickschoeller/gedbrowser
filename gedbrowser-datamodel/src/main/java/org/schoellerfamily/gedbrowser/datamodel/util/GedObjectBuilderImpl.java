 ...
 */
public final class GedObjectBuilderImpl implements GedObjectBuilder, PersonBuilderFacade,
     ...
     * @param root the root
     */
    public GedObjectBuilderImpl(final Root root) {
        this.root = root;
