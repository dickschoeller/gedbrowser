...
final class ChildConstructorTest {
    ...
    @ParameterizedTest
    @MethodSource("params")
    void testConstructChildToString(final Family parent, final String string, final ObjectId xref,
    ...
    @ParameterizedTest
    @MethodSource("params")
    void testConstructChildFromString(final Family parent, final String string, final ObjectId xref,
        final String expectedString, final String expectedToString,
        final String expectedFromString) {
        final Child child = new Child(parent, string, xref);
    ...
    @ParameterizedTest
    @MethodSource("params")
    void testConstructChildParent(final Family parent, final String string, final ObjectId xref,
        final String expectedString, final String expectedToString,
        final String expectedFromString) {
        final Child child = new Child(parent, string, xref);
    ...
    @ParameterizedTest
    @MethodSource("params")
    void testConstructChildString(final Family parent, final String string, final ObjectId xref,
        final String expectedString, final String expectedToString,
        final String expectedFromString) {
        final Child child = new Child(parent, string, xref);
