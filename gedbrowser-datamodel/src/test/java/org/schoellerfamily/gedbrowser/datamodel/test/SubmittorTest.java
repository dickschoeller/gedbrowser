...
public final class SubmittorTest {
    ...
    public void testSubmittorSurname() {
        ...
        final Submittor submittor = builder.createSubmittor("S1",
                "Richard John/Schoeller/");
        assertEquals("Mismatch surname", "Schoeller", submittor.getSurname());
    }
    ...
    public void testSubmittorNullName() {
        ...
        assertEquals("Expected null name", "", submittor2.getName().toString());
    }
    ...
    public void testSubmittorNullSurname() {
        final GedObjectBuilder builder = new GedObjectBuilder();
        final Submittor submittor2 = builder.createSubmittor("S2");
        assertEquals("Expected ? surname", "?", submittor2.getSurname());
    }
    ...
    public void testSubmittorRootParent() {
        final Submittor submittor = new Submittor(root, new ObjectId("SUB1"));
    ...
    public void testSubmittorNullEmptyParent() {
        Submittor submittor;
        submittor = new Submittor(null, new ObjectId(""));
        assertNull("Expected null parent", submittor.getParent());
    }
    ...
    public void testSubmittorRootEmptyParent() {
        Submittor submittor;
        submittor = new Submittor(root, new ObjectId(""));
        assertEquals("Mismatched parent", root, submittor.getParent());
    }
    ...
    public void testSubmittorNullStringParent() {
        Submittor submittor;
        submittor = new Submittor(null, new ObjectId(TEST_STRING));
        assertNull("Expected null parent", submittor.getParent());
    }
    ...
    public void testSubmittorRootStringParent() {
        Submittor submittor;
        submittor = new Submittor(root, new ObjectId(TEST_STRING));
        assertEquals("Mismatched parent", root, submittor.getParent());
    }
    ...
    public void testSubmittorNullEmptyNullParent() {
        final Submittor submittor = new Submittor(null, new ObjectId(""));
        assertNull("Expected null parent", submittor.getParent());
    }
    ...
    public void testSubmittorRootEmptyNullParent() {
        final Submittor submittor = new Submittor(root, new ObjectId(""));
        assertEquals("Mismatched parent", root, submittor.getParent());
    }
    ...
    public void testSubmittorNullNullStringParent() {
        final Submittor submittor = new Submittor(null, null);
        submittor.appendString(TEST_STRUNG);
        assertNull("Expected null parent", submittor.getParent());
    }
    ...
    public void testSubmittorNullNullStringString() {
        final Submittor submittor = new Submittor(null, null);
        submittor.appendString(TEST_STRUNG);
        assertEquals("Mismatched string", TEST_STRUNG, submittor.getString());
    }
