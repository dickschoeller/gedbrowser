...
public final class SubmitterLinkTest {
     ...
     */
    public SubmitterLinkTest(final GedObject parent, final String string,
    ...
    public void testThreeArgumentConstructor() {
        final SubmitterLink sourceLink = new SubmitterLink(parent, string,
                xref);
     ...
     */
    private void assertMatch(final SubmitterLink sourceLink,
