...
public final class LinkConstructorTest {
    ...
    @ParameterizedTest
    @MethodSource("params")
    public void testOneArgumentConstructor(final Person parent, final String string,
    ...
    @ParameterizedTest
    @MethodSource("params")
    public void testTwoArgumentConstructor(final Person parent, final String string,
            final ObjectId xref, final String expectedString,
            final String expectedToString, final String expectedFromString) {
    ...
    @ParameterizedTest
    @MethodSource("params")
    public void testThreeArgumentConstructor(final Person parent, final String string,
            final ObjectId xref, final String expectedString,
            final String expectedToString, final String expectedFromString) {
