...
public class WifeConstructorTest {
    ...
    @ParameterizedTest
    @MethodSource("params")
    public void testConstructWifeToString(final Family parent, final String string,
    ...
    @ParameterizedTest
    @MethodSource("params")
    public void testConstructWifeFromString(final Family parent, final String string,
            final ObjectId xref, final String expectedString,
            final String expectedToString, final String expectedFromString) {
        final Wife wife = new Wife(parent, string, xref);
    ...
    @ParameterizedTest
    @MethodSource("params")
    public void testConstructWifeParent(final Family parent, final String string,
            final ObjectId xref, final String expectedString,
            final String expectedToString, final String expectedFromString) {
        final Wife wife = new Wife(parent, string, xref);
    ...
    @ParameterizedTest
    @MethodSource("params")
    public void testConstructWifeString(final Family parent, final String string,
            final ObjectId xref, final String expectedString,
            final String expectedToString, final String expectedFromString) {
        final Wife wife = new Wife(parent, string, xref);
