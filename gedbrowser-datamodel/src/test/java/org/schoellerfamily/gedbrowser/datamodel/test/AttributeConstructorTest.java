...
public final class AttributeConstructorTest {
    ...
    @ParameterizedTest
    @MethodSource("params")
    void testTwoArgumentConstructor(final GedObject parent, final String string, final String tail,
        final GedObject expectedParent, final String expectedString, final String expectedTail) {
    ...
    @ParameterizedTest
    @MethodSource("params")
    void testOneArgumentConstructor(final GedObject parent, final String string, final String tail,
        final GedObject expectedParent, final String expectedString, final String expectedTail) {
