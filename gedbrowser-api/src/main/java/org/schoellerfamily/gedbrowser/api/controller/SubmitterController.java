...
public class SubmitterController
     ...
     */
    @GetMapping(value = "/dbs/{db}/submitters")
    @ResponseBody
     ...
     * @return the person
     */
    @GetMapping(value = "/dbs/{db}/submitters/{id}")
    @ResponseBody
     ...
     */
    @GetMapping(value = "/dbs/{db}/submitters/{id}/attributes")
    @ResponseBody
     ...
     * @return the attribute
     */
    @GetMapping(value = "/dbs/{db}/submitters/{id}/attributes/{index}")
    @ResponseBody
     ...
     * @return the attribute
     */
    @GetMapping(value = "/dbs/{db}/submitters/{id}/{type}")
    @ResponseBody
    public List<ApiAttribute> readSubmitterAttributes(
            @PathVariable final String db,
            @PathVariable final String id,
     ...
     * @return the attribute
     */
    @GetMapping(value = "/dbs/{db}/submitters/{id}/{type}/{index}")
    @ResponseBody
    public ApiObject readSubmitterAttribute(
            @PathVariable final String db,
            @PathVariable final String id,
