            ...
            <mat-card-content>
                <mat-table #table [dataSource]="datasource" matSort>
                  <ng-container matColumnDef="title">
                    ...
                    <mat-cell *matCellDef="let source" (click)="navigate(source.string)" (keydown.enter)="navigate(source.string)" (keydown.space)="navigate(source.string)" style="cursor: pointer;">{{ source.title }}</mat-cell>
                  </ng-container>
                  <ng-container matColumnDef="string">
                    <mat-header-cell *matHeaderCellDef mat-sort-header> ID </mat-header-cell>
                    <mat-cell *matCellDef="let source" (click)="navigate(source.string)" (keydown.enter)="navigate(source.string)" (keydown.space)="navigate(source.string)" style="cursor: pointer;">[{{ source.string }}]</mat-cell>
                  </ng-container>
