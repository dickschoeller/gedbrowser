...
public class ApiObjectTest {
    ...
    public void testDefaultConstructorType() {
        final ApiObject o = ApiObject.builder().type("").string("").attributes(java.util.List.of()).build();
    ...
    public void testConstructorType() {
        final ApiObject o = ApiObject.builder().type("type").string("string").attributes(java.util.List.of()).build();
    ...
    public void testConstructorWithAttributes() {
        final List<ApiAttribute> attributes = List.of(ApiAttribute.builder().type("attribute").string("a string").tail("").attributes(java.util.List.of()).build());
        final ApiObject o = ApiObject.builder().type("type").string("string").attributes(attributes).build();
