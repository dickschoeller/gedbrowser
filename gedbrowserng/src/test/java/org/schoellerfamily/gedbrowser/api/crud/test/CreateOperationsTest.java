...
import org.schoellerfamily.gedbrowser.api.crud.CreateOperations;
...
/**
 * Contains tests for create operations.
 */
final class CreateOperationsTest {

    @Test
    @SuppressWarnings("unchecked")
    void testSaveReturnsNullWhenRepositoryThrows() {
        ...
        final CreateOperationsStub createOperations =
            new CreateOperationsStub(repository, converter, transformer);
        ...
        assertNull(createOperations.save(object));
    }

    /**
     * Test stub for CreateOperations default methods.
     */
    @RequiredArgsConstructor
    private static final class CreateOperationsStub
        implements CreateOperations<Root, RootDocument, ApiObject> {
        /** */
        ...
        @Override
        public ApiObject createOne(final String db, final ApiObject object) {
            return null;
        }
    }
}
