...
public class SubmittorsControllerTest implements MenuTestHelper {
    ...
    /** */
    @Test
    public final void testSubmittorsControllerOK() {
        ...
        then(entity.getBody()).contains("<title>Submittors - gl120368</title>")
            ...
            .contains("href=\"submittor?db=gl120368&amp;id=U2\">Arthur PUNCHA")
            .contains("href=\"submittor?db=gl120368&amp;id=U4\">Created by Fa")
