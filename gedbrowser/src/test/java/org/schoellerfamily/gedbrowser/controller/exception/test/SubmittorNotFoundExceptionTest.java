 ...
 */
public class SubmittorNotFoundExceptionTest {
    /** */
    private SubmittorNotFoundException exception;

    /** */
    @Before
    public void setUp() {
        final ApplicationInfo appInfo = new ApplicationInfoImpl();
        exception = new SubmittorNotFoundException("Submittor not found", "ID1",
    ...
    public void testMessage() {
        assertEquals("Message doesn't match", "Submittor not found",
    ...
    /** */
    @Test
    public void testSubmittorId() {
        assertEquals("Submittor ID doesn't match", "ID1",
                exception.getSubmittorId());
    }
